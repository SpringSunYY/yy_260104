...
from ruoyi_house.controller import like as like_bp
from ruoyi_house.domain.entity import Like
from ruoyi_house.service.like_service import LikeService
...
@PathValidator()
@PreAuthorize(HasPerm('house:like:query'))
@JsonSerializer()
def get_like(id: int):
    """获取用户点赞详细信息"""
...
@PathValidator()
@PreAuthorize(HasPerm('house:like:remove'))
...
@PreAuthorize(HasPerm('house:like:export'))
...
@FileUploadValidator()
@PreAuthorize(HasPerm('house:like:import'))
