...
from ruoyi_house.controller import view as view_bp
from ruoyi_house.domain.entity import View
from ruoyi_house.service.view_service import ViewService
...
@PreAuthorize(HasPerm('house:view:list'))
@JsonSerializer()
...
@PathValidator()
@PreAuthorize(HasPerm('house:view:query'))
@JsonSerializer()
def get_view(id: int):
    """获取用户浏览详细信息"""
...
@BodyValidator()
@PreAuthorize(HasPerm('house:view:add'))
...
@BodyValidator()
@PreAuthorize(HasPerm('house:view:edit'))
...
@PathValidator()
@PreAuthorize(HasPerm('house:view:remove'))
...
@PreAuthorize(HasPerm('house:view:export'))
...
@FileUploadValidator()
@PreAuthorize(HasPerm('house:view:import'))
